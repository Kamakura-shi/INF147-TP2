	                             ...
	                             const unsigned int    taille)
{
	...
	/* Compter le nombre d'apparitions de chacune des lettres du message  */

	for (int i = 0; i < taille; i++)             /* On parcout tout le message  */
	{
...
{	
	...
	/* Appel de sous programme pour le calcul de fréquence  */
	...
	/* Appel de sous programme pour le decryptage de message  */
